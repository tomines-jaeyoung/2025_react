...
function FancyBorder(props) {
    return (
        <div className={'FancyBorder FancyBorder-' + props.color} style={props.style}>
            {props.children}
        </div>
    );
}
...
function ClownBox() {
    ...
    return (
        <FancyBorder color="blue" style={{ width: '80px', margin: '0 auto' }}>
            ...
            {isOpen ? (
                <div style={{ textAlign: 'center' }}>
                    ...
                    />
                    <h2 style={{ color: 'red', fontSize: '20px', width: '600px', marginLeft: '-240px'}}>
                ...
                <div style={{ textAlign: 'center' }}>
                    <button onClick={handleClick} style={{ padding: '10px 20px', fontSize: '13px', cursor: 'pointer' }}>
                        절대 누르지 마시오 🚫
                    </button>
                </div>
            )}
